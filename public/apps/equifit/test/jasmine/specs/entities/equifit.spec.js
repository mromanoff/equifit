define(function(require) {
    ...
    describe('Equifit Entity Model', function() {
        ...
        it('should have certain defaults', function(){
            ...
            expect(equifit.get('clientId')).toBeNull();
            expect(equifit.get('clientName')).toBeNull();
            expect(equifit.get('isSigned')).toBe(false);
            expect(equifit.get('isValidated')).toBe(false);
            expect(equifit.get('documents')).toBeNull();
        });
    });
});
