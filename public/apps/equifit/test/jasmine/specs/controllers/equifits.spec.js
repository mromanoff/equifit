...
//    var ActionView = require('views/action');
    ...
    describe('Equifits Controller Module', function() {
        ...
        it('has init method', function() {
            expect(EquifitsModule.init).toBeDefined();
           // expect(EquifitsModule.init instanceof Function).toBe(true);
            expect(EquifitsModule.init).toEqual(jasmine.any(Function));
        });

        it('calls init method', function() {
            spyOn(EquifitsModule, 'init');
            EquifitsModule.init(function () {});
            expect(EquifitsModule.init).toHaveBeenCalledWith(jasmine.any(Function));
        });
